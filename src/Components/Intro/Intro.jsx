    ...
    return(
        <div className="intro" id='Home'>
          ...
          <a href={resume}> <button className='button i-button'>Hire Me</button> </a> 
            ...
            style={{...springs}}
            src={glassesimoji} alt="" springs/>
            <animated.div className="floating-div" style={{top: '-4%', left: '50%', transition: "ease-in-out 5s",...spring}}>
                <FloatingDiv image={Crown} txt1='Web' txt2='Developer'/>
            </animated.div>
            <animated.div className="floating-div"style={{top: '18rem', left: '-15rem', transition: "ease-in-out 5s",...springs}}>
